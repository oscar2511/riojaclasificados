...
function osc_set_telephone_number() {
    ...
    <div class="box control-group">
        <div class="row">
            <label for="telephone"><?php _e('Teléfono', 'telephone'); ?></label>
            <div class="controls">
...
function osc_telephone_number() {
    if(osc_is_ad_page()) {
        ...
        if (isset($detail['s_telephone'])) { ?>
			<?php _e('', 'telephone'); ?> <?php echo $detail['s_telephone']; ?>
<!--<div style="display:block;margin-bottom:5px;" class="phone_telephone"><?php _e('', 'telephone'); ?> <?php echo $detail['s_telephone']; ?></div>-->
        <?php }
    }
}
